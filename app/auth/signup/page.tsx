            ...
            >
                <div className="bg-white/70 backdrop-blur-2xl border border-white/50 shadow-[0_8px_32px_0_rgba(154,37,134,0.08)] rounded-[2.5rem] p-8 md:p-10 space-y-6">
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <p className="text-sm font-yekan text-accent font-medium">لطفا مشخصات خود را وارد کنید</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-sm font-yekan font-bold text-secondary/80 mr-2">تکرار رمز عبور</label>
                            <div className="relative group">
                                <input
                                    type="password"
                                    ...
                                    placeholder="••••••••"
                                />
                                <CheckCircle2 className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-secondary/40 group-focus-within:text-primary transition-colors" />
                            </div>
                        </div>

                        <div className="flex items-center gap-2 text-[10px] font-yekan pt-1 text-secondary/60">
                            <p>با ثبت‌نام شما تمام <span className="text-primary font-bold cursor-pointer hover:underline">قوانین و مقررات</span> زیگو را پذیرفته‌اید.</p>
                        </div>
